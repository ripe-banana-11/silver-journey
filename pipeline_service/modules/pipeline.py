...
class GenerationPipeline:
    ...
    async def prepare_input_images(
        ...
        left_image_edited = self.qwen_edit.edit_image(
            prompt_image=image,
            seed=seed,
            prompt="Show the main subject on the perfectly flat background.\nMake sure the subject is fully visible.\nTurn background solid warm gray color.\nKeep exactly the same design, pose, proportions, materials, texture, and COLORS as in the original image.\nDo not change color, brightness, contrast, saturation, hue, white balance, or lighting direction on the subject.",
        )

        # right view
        right_image_edited = self.qwen_edit.edit_image(
            prompt_image=left_image_edited,
            seed=seed,
            prompt="Edit this image so that it is shown in a three-quarters view from the left side.\nKeep exactly the same design, pose, proportions, materials, texture, and COLORS as in the original image.\nDo not change lighting direction on the subject.",
        )
        ...
        #     prompt_image=left_image_edited,
        #     seed=seed,
        #     prompt="Edit this image so that it is shown from the front and a bit from above.\nKeep exactly the same design, pose, proportions, materials, texture, and COLORS as in the original image.\nDo not change lighting direction on the subject.",
        # )
